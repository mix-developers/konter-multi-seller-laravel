...
@section('content')
                                    ...
                                    <tbody>
                                        @foreach ($konter as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $item->name }}<br>
                                                    <p class="text-muted">Pemilik : {{ $item->pemilik->name }}</p>
                                                </td>
                                                <td>
                                                    {{ $item->address }}<br>
                                                    <p class="text-muted">Buka : <span
                                                            class="badge badge-light-success">{{ $item->time_open }}</span>
                                                        - <span
                                                            class="badge badge-light-danger">{{ $item->time_close }}</span>
                                                    </p>
                                                </td>
                                                <td width="200">
                                                    ...
                                                    <button type="button" class="btn btn-light-warning btn-md"
                                                        ...
                                                        Edit</button>
                                                    @include('admin.konter.modal_edit')
    ...
    @include('admin.konter.modal_create')
@endsection
